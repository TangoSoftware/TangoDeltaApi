...
[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.9.0.0 (Newtonsoft.Json v13.0.0.0)")]
public class RENGLON_ANALITICO_DTO
{
...
[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.9.0.0 (Newtonsoft.Json v13.0.0.0)")]
public class TIPO_AUXILIAR_DTO
{
    ...
    [Newtonsoft.Json.JsonProperty("EDITA_REGLA", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    public bool EDITA_REGLA { get; set; }
...
{
    [Newtonsoft.Json.JsonProperty("NRO_ORDEN", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
...
[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.9.0.0 (Newtonsoft.Json v13.0.0.0)")]
public class AsientosData : BaseData
{
    ...
    [Newtonsoft.Json.JsonProperty("IMPORTE_AUXILIARES_TEXTO", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    public string IMPORTE_AUXILIARES_TEXTO { get; set; }

    [Newtonsoft.Json.JsonProperty("ID_REGLA_APROPIACION", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    public int? ID_REGLA_APROPIACION { get; set; }

    [Newtonsoft.Json.JsonProperty("IMPORTE_AUXILIARES", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    public decimal IMPORTE_AUXILIARES { get; set; }

    [Newtonsoft.Json.JsonProperty("ID_CUENTA_AUXILIAR", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    public int? ID_CUENTA_AUXILIAR { get; set; }

    [Newtonsoft.Json.JsonProperty("IMPORTE_UA_AUXILIAR", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    public decimal? IMPORTE_UA_AUXILIAR { get; set; }

    [Newtonsoft.Json.JsonProperty("CANTIDAD_UA_AUXILIAR", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    public decimal? CANTIDAD_UA_AUXILIAR { get; set; }
    ...
    public System.Collections.Generic.ICollection<TIPO_AUXILIAR_DTO> TIPO_AUXILIAR_DTO { get; set; }
