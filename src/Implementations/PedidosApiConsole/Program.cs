...
ITangoConfig config = new TangoConfig()
{
    ...
    ApiAuthorization = "9ba5edf3-c2d1-4aaa-91c3-b791a9862eae",
    CompanyId = "24"
};
...
{
    pedido.ID_DIRECCION_ENTREGA = clienteDataset.DireccionEntrega[0].IdDireccionEntrega;
}
...
// Ingresa Aprobado. Si es necesario que utilice el circuito de aprobación pasar ESTADO = 1 y configurar en Parámetros de Ventas las condiciones de aprobación
pedido.ESTADO = 2;
...
pedido.RENGLON_DTO = [
    ...
    new RenglonDto()
    {
        // Artículo: Busco el ID del artículo que tenga el campo COD_STA11 = '0100100267'
        ID_STA11 = articuloServices.GetByFilter("AXV_ARTICULO.COD_STA11 = '0100100267'").Single().IdSta11,
        MODULO_UNIDAD_MEDIDA = "GV",
        CANTIDAD_PEDIDA = 1,
        // Precio: en este ejemplo pongo un precio especifico. En caso de no tenerlo, se puede buscar el precio por lista de precios automáticamente
        PRECIO = 15000
...
try
{
    ...
    Console.WriteLine($"Id Pedido {savedId} creado con éxito!");
}
catch (Exception ex)
{
...
pedidoClienteOcasional.CLIENTE_OCASIONAL_DTO = [
...
// Cargamos los renglones del pedido
pedidoClienteOcasional.RENGLON_DTO = [
    new RenglonDto()
    {
        // Artículo: Busco el ID del artículo que tenga el campo COD_STA11 = '0100100134'
        ID_STA11 = articuloServices.GetByFilter("AXV_ARTICULO.COD_STA11 = '0100100134'").Single().IdSta11,
