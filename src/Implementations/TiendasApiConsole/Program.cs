...
public class TiendasApiClient
{
    ...
    {
        TangoUrl = $"https://{Llave}.connect.axoft.com/api/tiendas/", // Cambia esto por la URL base de la API.
        ApiAuthorization = "tu_token_de_desarrollador",
        CompanyId = "1"
    };
    ...
    public TiendasApiClient()
    {
        ...
        client.DefaultRequestHeaders.Add("ApiAuthorization", config.ApiAuthorization);
        client.DefaultRequestHeaders.Add("Company", config.CompanyId);
    }
    ...
    public async Task GetPriceList(string pageSize)
    {
        try
        {
            string endpoint = $"{config.TangoUrl}/PriceList?pageSize={pageSize}";
    ...
    public async Task PostOrder(string jsonOrderBody)
    {
        try
        {
            string endpoint = $"{config.TangoUrl}/Order";
...
public class Program
{
    public static async Task Main()
    {
        ...
        await apiClient.GetPriceList(pageSize: "500");
...
                          }
        ...
        await apiClient.PostOrder(jsonBody);
    }
}
